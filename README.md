...
A simple, practical solution to import and synchronize KBO/BCE/CBE data to your own database (e.g., SQL Server, Postgres, Sqlite, Oracle, ...). It provides clear source abstractions and replaceable storage backends. The acronym CBE stand for "_Crossroads Bank for Enterprises in Belgium_", and is also known as:
...
CBE data is provided by the Belgian Governement and is publicly available: [https://economie.fgov.be/](https://economie.fgov.be/en/themes/enterprises/crossroads-bank-enterprises/services-everyone/public-data-available-reuse/cbe-open-data)
